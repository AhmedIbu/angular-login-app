...
hashed_password = generate_password_hash("example1")  # Replace with your real password
...
def register():
    ...
    phone = data.get("phone")  # ✅ Added missing phone field
    address = data.get("address")  # ✅ Added missing address field
    ...
    try:
       ...
       # ✅ Insert new user
        cursor.execute("INSERT INTO users (name, email, phone, address, password) VALUES (%s, %s, %s, %s, %s)", 
